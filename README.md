...
For a complete example of what the agent generates, see [PR #16](https://github.com/neo4j-partners/org-mcp-demo/pull/16) which shows a full Python Neo4j client library generated by the custom agent, including models, repository patterns, tests, and documentation.
